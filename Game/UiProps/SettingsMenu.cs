...
namespace DemoGame
{
    public class SettingsMenu : Menu
    {
        ...
        public UIAlignContainer GraphicsCard;

        public UIAlignContainer AudioCard;

        public UIAlignContainer BackCard;

        public SettingsMenu(Scene scene, string key) : base(scene, key)
        {
        }
        ...
        public override void Start()
        {
            ...
            this.TitleCard = CreateCard("Settings", "UI/BigUIBox", "TitleCard");
            this.GraphicsCard = CreateCard("Video", "UI/MedUIBox", "VideoCard");
            this.AudioCard = CreateCard("Audio", "UI/MedUIBox", "AudioCard");
            ...
            this.GraphicsCard.OnLeftClick += (object sender, EventArgs e) =>
            {
