...
namespace DemoGame
{
    public class FullScreenMenu : Menu
    {
        public FullScreenMenu(Scene scene, string key) : base(scene, key)
        {
        }
        ...
        public override void Start()
        {
            ...
            CreateCard("Set Window", "UI/BigUIBox", "FullscreenTitleCard", true);
            CreateCard("Fullscreen", "UI/MedUIBox", "FullscreenCard", true);
            CreateCard("Windowed", "UI/MedUIBox", "WindowCard", false);
        }

        private UIAlignContainer CreateCard(string text, string texturePath, string name, bool fullscreen)
        {
